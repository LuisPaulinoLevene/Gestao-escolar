...
from models.funcionarios_secretaria import FuncionarioSecretaria as FuncionarioSecretariaModel
from schemas.funcionarios_secretaria import FuncionarioSecretariaCreate, FuncionarioSecretariaResponse
